    ...
    <div className='main-content-container'>
      <div className="sub-container-1">
        ...
        <div className="winner-cards-wrapper">
          <WinnerCard winner1={players["player1"]} first_winner={avatars["first_winner"]}
            winner2={players["player2"]} second_winner={avatars["second_winner"]}
            winner3={players["player3"]} third_winner={avatars["third_winner"]} />
        </div>
      ...
      <div className="sub-container-2">
        ...
        <LeaderBoardPlayerCard rank="#01" name={players["player1"]} scores="00000" />
        <LeaderBoardPlayerCard rank="#02" name={players["player2"]} scores="00000" />
        <LeaderBoardPlayerCard rank="#03" name={players["player3"]} scores="00000" />
